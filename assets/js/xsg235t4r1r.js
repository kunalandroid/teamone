        ...
        "string" == e.type(t) && (t = e.trim(t)),
          e(t).each(function (t) {
            ...
            i ? s.container.prepend(o) : s.container.append(o),
              ...
              i
                ? (s.slides = e(o).add(s.slides))
                : (s.slides = s.slides.add(o)),
    ...
    $(".options-panel .panel-button").click(function () {
      ...
      $("#overlay-skin p").click(function () {
        $("#overlay-skin p").removeClass("active"),
          ...
          $(this).hasClass("overlay-skin-white")
            ? $("body").addClass("white")
      ...
      $("#bullet-navigation p").click(function () {
        $("#bullet-navigation p").removeClass("active"),
          $(this).addClass("active"),
          $(this).hasClass("bullet-navigation-on")
            ? $(".grcs_bullet_nav").show()
            : $(".grcs_bullet_nav").hide();
      }),
    ...
    !(function (e, o, a, s) {
      ...
      switch (
          ...
          (function () {
            ...
            g(),
              $(".grcs_bullet_nav .nav_dots").click(function () {
                (i = $(".grcs_bullet_nav .nav_dots").index(this)) != f &&
                  (i < f ? ((c = !0), p()) : ((c = !0), b()));
              });
          })(),
        d.click(function () {
        ...
        $("html").on("DOMMouseScroll mousewheel", function (e) {
          (e.originalEvent.wheelDelta || -1 * e.originalEvent.detail) / 120 <
            0 && b();
        }),
        $("html").on("DOMMouseScroll mousewheel", function (e) {
          (e.originalEvent.wheelDelta || -1 * e.originalEvent.detail) / 120 >
            ...
            $(
              ...
              setTimeout(function () {
                "" !== e.nameMessage &&
                  ($("#contact-form-name")
                    .addClass("active")
                    .attr("placeholder", e.nameMessage),
                  $("#contact-form").addClass("error")),
                  "" !== e.emailMessage &&
                    ($("#contact-form-email")
                      .addClass("active")
                      .val("")
                      .attr("placeholder", e.emailMessage),
                    $("#contact-form").addClass("error")),
                  "" !== e.messageMessage &&
                    ($("#contact-form-message")
                      .addClass("active")
                      .attr("placeholder", e.messageMessage),
                    $("#contact-form").addClass("error"));
              }, 50),
              "" === e.nameMessage &&
                "" === e.emailMessage &&
                ...
                $("#contact-form textarea, #contact-form input").attr(
                  "placeholder",
                  ""
                ),
                $("#contact-form textarea").attr(
                  "placeholder",
                  e.succesMessage
                ),
                $(
...
$(document).ready(function () {
    ...
    !(function () {
      ...
      (a = document.createElement("div")),
        ...
        ((t = new THREE.PerspectiveCamera(
          ...
          1,
          1e4
        )).position.z = option_hero_background_sphere_distance),
        (e = new THREE.Scene()),
    ...
    !(function () {
      (t = document.createElement("div")),
        ...
        ((e = new THREE.PerspectiveCamera(
          ...
          1,
          1e4
        )).position.z = option_hero_background_waves_distance),
        (o = new THREE.Scene()),
        (n = new Array());
      for (
        var u = 2 * Math.PI,
        ...
        !(function () {
          if (y) {
            ...
            for (var t = 0, s = 0; s < r; s++)
              for (var c = 0; c < h; c++)
                ((a = n[t++]).position.y =
                  50 * Math.sin(0.3 * (s + u)) + 50 * Math.sin(0.5 * (c + u))),
                  (a.scale.x = a.scale.y =
                    4 * (Math.sin(0.3 * (s + u)) + 1) +
                    4 * (Math.sin(0.5 * (c + u)) + 1));
            i.render(o, e), (u += 0.1);
          }
        })();
      })();
  ...
  function i() {
      ...
      (t = Date.now() - u),
        (function () {
          ...
          for (s = o.lights.length - 1; s >= 0; s--) {
            ...
            var _ = Math.clamp(
                FSS.Vector3.distanceSquared(r.position, g),
                c.minDistance,
                c.maxDistance
              ),
    ...
    if (
      ...
      (function () {
        var t, i;
        for (t = o.lights.length - 1; t >= 0; t--)
          (i = o.lights[t]), o.remove(i);
        for (e.clear(), t = 0; t < c.count; t++)
          ((i = new FSS.Light(
            c.ambient,
            c.diffuse
          )).ambientHex = i.ambient.format()),
            ...
            (this.setCanvas = function () {
              (t.width = h.width),
                ...
                (e && e.hasOwnProperty("position")) ||
                  (h.position = { x: 0.5 * t.width, y: 0.5 * t.height });
            }),
  ...
  switch (option_hero_background_mode) {
      ...
      (r = option_hero_background_gradient_colorArray),
        ...
        setInterval(function () {
          ...
          c
            ...
            .css({
              background:
                "-moz-linear-gradient(left, " + a + " 0%, " + s + " 100%)",
            }),
            (h += u) >= 1 &&
              ((h %= 1),
              (l[0] = l[1]),
              (l[2] = l[3]),
              (l[1] =
                (l[1] + Math.floor(1 + Math.random() * (r.length - 1))) %
                r.length),
              (l[3] =
                (l[3] + Math.floor(1 + Math.random() * (r.length - 1))) %
                r.length));
        }, 1),
        $(".hero .bg-color").css("opacity", "1"),
        $(".hero .bg-pattern").remove(),
      ...
      !(function () {
            ...
            (function () {
              for (var t = -n / 2; t < o + n; t += n) {
                ...
                for (var e = -n / 2; e < i + n; e += n)
                  t == -n / 2 && d++,
                    g.push(new _({ x: ~~(t + m(-a, a)), y: ~~(e + m(-a, a)) }));
              }
            })(),
        ...
        (_.prototype.step = function () {
          (this.x =
            this.xBase +
            this.dir *
              Math.sin((p + this.offset) / this.duration) *
              this.range),
            (this.y =
              this.yBase +
              this.dir *
                Math.cos((p + this.offset) / this.duration) *
                this.range);
          var t,
            e,
            o,
    ...
    case "space":
      !(function (t, e, o, i) {
        ...
        !(function () {
          for (
            var t = 0, o = ["ms", "moz", "webkit", "o"], i = 0;
            i < o.length && !e.requestAnimationFrame;
            ++i
          )
          ...
          (r.prototype = {
            ...
            init: function () {
              ...
              (this.n = parseInt(
                ...
                s.starz[0].getContext &&
                  ((s.context = s.starz[0].getContext("2d")), (c = !0)),
    ...
    case "glitch":
      (s =
        ...
        $(".hero .level-2 .bg-image").append(
          '<div class="glitch-img" style="' + s + '"></div>'
        ),
        $(".glitch-img").mgGlitch({
          destroy: !1,
          glitch: !0,
  ...
  "slider" === option_hero_background_mode &&
    ((g = option_hero_background_slider_transitionDuration),
